...
APP = equilibre.out
CSRC = $(SRCDIR)/main.c $(SRCDIR)/grille.c $(SRCDIR)/file.c $(SRCDIR)/couleur.c $(SRCDIR)/affichage.c $(SRCDIR)/tree.c
CHDR = $(HDIR)/grille.h $(HDIR)/file.h $(HDIR)/couleur.h $(HDIR)/affichage.h $(HDIR)/tree.h
COBJMAIN = $(OBJDIR)/main.o
COBJ = $(OBJDIR)/grille.o $(OBJDIR)/file.o $(OBJDIR)/couleur.o $(OBJDIR)/affichage.o $(OBJDIR)/tree.o
...
$(COBJ): $(CSRC) $(CHDR) $(OBJDIR)
	...
	$(CC) $(CFLAGS) -o $(OBJDIR)/tree.o -c $(SRCDIR)/tree.c
